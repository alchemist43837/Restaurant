...
setInterval(() => {
	ajaxCall('http://localhost/wrst/workstation/JS/Clase7/materiales_ejercitacion/get.php', getMovies);
}, 1000);
...
form.addEventListener('submit', (e) => {
	...
	if (
		...
		ajaxCall('http://localhost/wrst/workstation/JS/Clase7/materiales_ejercitacion/post.php', setMovie, {
			method: 'POST',
			body: formData
		});
